              ...
              <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
                ...
                {fixtureWizardStep === 4 && (
                  <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
                    ...
                    {drawnMatchCount > 0 && (
                      <div className="bg-white/[0.02] border border-white/10 rounded-3xl overflow-hidden max-h-[500px] flex flex-col animate-in slide-in-from-top-4 fade-in duration-500">
