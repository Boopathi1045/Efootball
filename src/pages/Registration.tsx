...
export default function Registration() {
  ...
  const [settings, setSettings] = useState<any>({ entryFee: "100", paymentNumber: "", paymentQrUrl: "" });
  ...
  const isFreeTournament = !settings.entryFee || settings.entryFee === "0" || settings.entryFee === 0;
    ...
    <div className="min-h-screen flex flex-col bg-background-dark">
      ...
      <div className="flex flex-col gap-3 p-4 mt-2 max-w-2xl mx-auto w-full">
        ...
        <div className="pt-6 pb-2">
          <h3 className="text-white tracking-tight text-3xl font-extrabold leading-tight">Join the eFootball Elite</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="w-full">
                  ...
                  <p className="text-background-light text-xs mt-1 leading-relaxed">
                    Transfer <b className="text-primary">₹{settings.entryFee} Entry Fee</b> to the official tournament number/UPI: <b className="text-primary">{settings.paymentNumber || "Not set"}</b>. Take a screenshot of the confirmation to upload below.
                  </p>
                  {settings.paymentQrUrl && (
                    <div className="mt-4 flex flex-col items-center bg-background-dark p-4 rounded-lg border border-primary/20">
                      ...
                      <img src={settings.paymentQrUrl} alt="Payment QR" className="w-40 h-40 object-contain rounded-lg bg-white p-2" />
                    </div>
                  )}
                </div>
              </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 py-4 mb-20">
